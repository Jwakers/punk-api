...
const AccordionItem = ({ item, isOpen, onClick, handleKeypress }) => {
    ...
    return (
        <div className={`${style.Accordion_item} ${isOpen && style.Accordion_item___open}`} onKeyPress={handleKeypress} tabIndex={id}>
            <div className={style.Accordion_item_head} onClick={onClick}>{name}</div>
